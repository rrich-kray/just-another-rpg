...
Game.prototype.startNewBattle = function(){
    if (this.player.agility > this.currentEnemy.agility) this.isPlayerTurn = true
...
}; //  Because these methods already passed our tests, we don't need to worry about them if the Game starts producing bugs. It will most likely be an issue with the game logic itself
